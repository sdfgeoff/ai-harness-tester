...
Top-level `results/index.json`:

- Is generated by the orchestrator when a batch completes.
- Is rebuilt from the current `results/` tree rather than updated incrementally.
- Lists batch summary paths newest-first.
...
```json
{
  "batches": [
    {
      "batch_id": "20260519T091530Z",
      "summary_path": "results/20260519T091530Z/summary.json"
    }
  ]
}
```
